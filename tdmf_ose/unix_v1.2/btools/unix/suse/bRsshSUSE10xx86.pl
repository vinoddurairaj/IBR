...
###################################
#
#  perl -w -I../../pms bRsshSUSE10xx86.pl
#
#    ssh to SUSE10x SP4 x86  bit build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"SuSE 10x SP4 x86  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"SuSE 10x SP4 x86  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"SuSE 10x SP4 x86  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"SuSE 10x SP4 x86  :  bldcmd rc = $?\"\""; 
...
print "\n\nSTART : bRrshSUSE10xx86.pl\n\n";

print "\n$RFXver / $TUIPver  ::::  $Bbnum\n\n";

print "\nsuse10xx86       =  $suse10xx86\n\n";
