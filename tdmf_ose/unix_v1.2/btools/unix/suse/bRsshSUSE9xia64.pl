...
###################################
#
#  perl -w -I../../pms bRsshSUSE9xia64.pl
#
#    ssh to SUSE9x SP4 ia64 bit build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"SuSE 9x SP4 ia64  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"SuSE 9x SP4 ia64  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"SuSE 9x SP4 ia64  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"SuSE 9x SP4 ia64  :  bldcmd rc = $?\"\""; 
...
print "\n\nSTART : bRrshSUSE9xia64.pl\n\n";

print "\n$RFXver / $TUIPver  ::::  $Bbnum\n\n";

print "\nsuse9xia64       =  $suse9xia64\n\n";
