...
###################################
#
#  perl -w -I../../pms bRsshSUSE11xia64.pl
#
#    ssh to SUSE11x SP4 ia64 bit build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
$RSH="ssh $suse11xia64 -l bmachine";
...
#$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"SuSE 11x SP4 ia64  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"SuSE 11x SP4 ia64  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"SuSE 11x SP4 ia64  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"SuSE 11x SP4 ia64  :  bldcmd rc = $?\"\""; 
...
print "\n\nSTART : bRrshSUSE11xia64.pl\n\n";

print "\n$RFXver / $TUIPver  ::::  $Bbnum\n\n";

print "\nsuse11xia64       =  $suse11xia64\n\n";
