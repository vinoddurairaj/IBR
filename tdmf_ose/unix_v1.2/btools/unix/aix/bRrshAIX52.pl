...
###################################
#
#  perl -w -I../../pms bRrshAIX52.pl
#
#    rsh to AIX52 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"AIX52  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"AIX52  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"AIX52  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"AIX52  :  bldcmd rc = $?\"\""; 
