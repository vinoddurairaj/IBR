...
###################################
#
#  perl -w -I../../pms bRrshSOL7.pl
#
#    rsh to SOL7 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"SOL7  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"SOL7  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"SOL7  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"SOL7  :  bldcmd rc = $?\"\""; 
