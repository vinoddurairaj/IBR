...
###################################
#
#  perl -w -I../../pms bRrshSOL8.pl
#
#    rsh to SOL8 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
$RSH="rsh $solaris8 -l bmachine";

$RSHcvsupdate="$RSH \"$pro ; cd $btoolsPath ; pwd ; cvs update ; echo \"cvs update rc = $?\"\""; 

$RSHrfxgetcode="$RSH \" $pro ; cd $btoolsPath/unix ; pwd ;  perl bRgetcodeSOL.pl ; echo \"bRgetcode.pl rc = $?\"\""; 

$RSHtuipgetcode="$RSH \" $pro ; cd $btoolsPath/unix ; pwd ;  perl bIgetcodeSOL.pl ; echo \"bRgetcode.pl rc = $?\"\""; 

#$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"SOL8  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"SOL8  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"SOL8  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"SOL8  :  bldcmd rc = $?\"\""; 
