...
our $RFXbldPath="../../../../builds/$Bbnum/Linux/SuSE/9x/s390x";
our $TUIPbldPath="../../../../builds/tuip/$Bbnum/Linux/SuSE/9x/s390x";
...
$ftp->cwd("builds/Replicator/UNIX/$RFXver/$Bbnum/zLinux/SuSE9x");
$ftp->binary;
$ftp->get("$RFXver.$Bbnum.zlinuxSuSE9x.tar");

$ftp->quit;

#######################################
#####################################
# tar xvf $RFXver.$Bbnum.zlinuxSuSE9x.tar && unlink
#####################################
#######################################
print "\n\n";

system qq(tar xvf $RFXver.$Bbnum.zlinuxSuSE9x.tar);

unlink "$RFXver.$Bbnum.zlinuxSuSE9x.tar";
...
$ftp->cwd("builds/TDMFUNIX\(IP\)/$TUIPver/$Bbnum/zLinux/SuSE9x");
$ftp->binary;
$ftp->get("$TUIPver.$Bbnum.zlinuxSuSE9x.tar");

$ftp->quit;

#######################################
#####################################
# tar xvf $TUIPver.$Bbnum.zlinuxSuSE9x.tar && unlink
#####################################
#######################################

print "\n\n";

system qq(tar xvf $TUIPver.$Bbnum.zlinuxSuSE9x.tar);

unlink "$TUIPver.$Bbnum.zlinuxSuSE9x.tar";
