...
###################################
#
#  perl -I../../.. bRsshSuSE9xs390.pl
#
#    ssh to SuSE9x 6 s390x (zLinux via rtp)
#    make  :  build it
#    make  :  package
...
our $btoolsPathZ="$LWORK/$SuSE9xPath/unix/zLinux/SuSE9x";
our $zsuse9xs390x64;

our $SSH="ssh -l bmachine $zsuse9xs390x64";

our $SSH0="$SSH \"$source ; uname -a ; cd $btoolsPathZ ; pwd ; cd ../../.. ; pwd ; cvs update ; echo \"cvs update rc = $?\"\""; 
our $SSH1="$SSH \"$source ; cd $btoolsPathZ ; pwd ; perl bRbuildSuSE9x.pl\""; 
our $SSH2="$SSH \"$source ; cd $btoolsPathZ ; pwd ; perl bRpostBuildSuSE9x.pl\""; 
...
unlink "SuSE9xs390x64.txt";
open (STDOUT, ">SuSE9xs390x64.txt");
open (STDERR, ">&STDOUT");
...
#####################################
###################################
#  ssh  :  exec remote bRbuildSuSE9x.pl  :  cvs checkout / ./bldcmd
###################################
#####################################

    system qq($SSH1);
    print "\nbRbuildSuSE9x.pl  :  SSH2  : rc = $?\n\n";

#####################################
###################################
#  ssh  :  exec remote bRpostBuildSuSE9x.pl  :  cvs checkout / ./bldcmd
###################################
#####################################

    system qq($SSH2);
    print "\nbRpostBuildSuSE9x.pl  :  SSH2  : rc = $?\n\n";
