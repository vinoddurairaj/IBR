...
#  perl -c bRcpRPM.pl
#
#    local cp RFX / TUIP *.rpm to /work/builds/B#####/SuSE9x 
#
###########################################
#############################################
...
system qq(cp $tdmfSrcPath/pkg.install/Rep*.rpm /work/builds/$Bbnum/SuSE9x);
...
system qq(cp $tdmfSrcPath/pkg.install/TDMF*.rpm /work/builds/$Bbnum/SuSE9x);
