...
#  perl -c bRcpRPM.pl
#
#    local cp RFX / TUIP *.rpm to /work/builds/RH5x/B##### 
#
...
system qq(cp $tdmfSrcPath/pkg.install/Rep*.rpm /work/builds/$Bbnum/RH5x);
...
system qq(cp $tdmfSrcPath/pkg.install/TDMF*.rpm /work/builds/$Bbnum/RH5x);
