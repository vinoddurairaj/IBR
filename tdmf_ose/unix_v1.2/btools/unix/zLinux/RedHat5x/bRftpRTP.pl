...
our $RFXbldPath="../../../../builds/$Bbnum/Linux/RedHat/5x/s390x";
our $TUIPbldPath="../../../../builds/tuip/$Bbnum/Linux/RedHat/5x/s390x";
...
$ftp->cwd("builds/Replicator/UNIX/$RFXver/$Bbnum/zLinux/RedHat5x");
$ftp->binary;
$ftp->get("$RFXver.$Bbnum.zlinuxRH5x.tar");

$ftp->quit;

#######################################
#####################################
# tar xvf $RFXver.$Bbnum.zlinuxRH5x.tar && unlink
#####################################
#######################################
print "\n\n";

system qq(tar xvf $RFXver.$Bbnum.zlinuxRH5x.tar);

unlink "$RFXver.$Bbnum.zlinuxRH5x.tar";
...
$ftp->cwd("builds/TDMFUNIX\(IP\)/$TUIPver/$Bbnum/zLinux/RedHat5x");
$ftp->binary;
$ftp->get("$TUIPver.$Bbnum.zlinuxRH5x.tar");

$ftp->quit;

#######################################
#####################################
# tar xvf $TUIPver.$Bbnum.zlinuxRH5x.tar && unlink
#####################################
#######################################

print "\n\n";

system qq(tar xvf $TUIPver.$Bbnum.zlinuxRH5x.tar);

unlink "$TUIPver.$Bbnum.zlinuxRH5x.tar";
