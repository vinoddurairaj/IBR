...
#  perl -c bRcpLOGSpl
#
#    local cp build LOGS to /work/builds/B#####/RH4x 
#
...
system qq(cp cprpm.txt /work/builds/$Bbnum/RH4x);
system qq(cp tarcvf.txt /work/builds/$Bbnum/RH4x);
system qq(cp isoZ.txt /work/builds/$Bbnum/RH4x);
