...
###################################
#
#  perl -w -I../../pms bRsshRH4xia64.pl
#
#    ssh to RH4xia64 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"RH4xia64  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"RH4xia64  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"RH4xia64  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"RH4xia64  :  bldcmd rc = $?\"\""; 
...
open (STDOUT, ">RedHatAS4xia64.txt");
open (STDERR, ">&STDOUT");
