...
###################################
#
#  perl -w -I../../pms bRsshRH4x64.pl
#
#    ssh to RH4x64 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"RH4x64  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"RH4x64  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"RH4x64  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"RH4x64  :  bldcmd rc = $?\"\""; 
