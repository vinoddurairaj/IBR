...
###################################
#
#  perl -w -I../../pms bRsshRH5xxia64.pl
#
#    ssh to RH5xxia64 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"RH5xia64  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"RH5xia64  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"RH5xia64  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"RH5xia64  :  bldcmd rc = $?\"\""; 
...
open (STDOUT, ">RedHatAS5xia64.txt");
open (STDERR, ">&STDOUT");
