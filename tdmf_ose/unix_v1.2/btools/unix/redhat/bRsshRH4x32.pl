...
###################################
#
#  perl -w -I../../pms bRsshRH4x32.pl
#
#    ssh to RH4x32 build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"RH4x32  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$source ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"RH4x32  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"RH4x32  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$source ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"RH4x32  :  bldcmd rc = $?\"\""; 
