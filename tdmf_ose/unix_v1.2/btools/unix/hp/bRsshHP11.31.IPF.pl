...
###################################
#
#  perl -w -I../../pms bRsshHP11.31.IPF.pl
#
#    ssh to HP1131IPF build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"HP1131IPF  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"HP1131IPF  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"HP1131IPF  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"HP1131IPF  :  bldcmd rc = $?\"\""; 
