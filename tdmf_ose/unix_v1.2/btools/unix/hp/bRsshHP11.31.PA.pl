...
###################################
#
#  perl -w -I../../pms bRsshHP11.31.PA.pl
#
#    ssh to HP1131PA build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"HP1131PA  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"HP1131PA  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"HP1131PA  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"HP1131PA  :  bldcmd rc = $?\"\""; 
