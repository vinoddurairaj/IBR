...
###################################
#
#  perl -w -I../../pms bRrshHP11i.pl
#
#    rsh to HP11i build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"HP11i  :  bldcmd rc = $?\"\""; 
$RSHrfxbldcmd="$RSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"HP11i  :  bldcmd rc = $?\"\""; 

#$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"HP11i  :  bldcmd rc = $?\"\""; 
$RSHtuipbldcmd="$RSH \"$pro ; cd $buildTreePathTuip ; pwd ;  $tuipBLDCMD  ; echo \"HP11i  :  bldcmd rc = $?\"\""; 
