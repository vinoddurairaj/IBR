...
###################################
#
#  perl -w -I../../pms bRsshHP11.23.IPF.pl
#
#    ssh to HP1123IPF build machine 
#    make  :  build it
#    make  :  package
#    ready for ftp 
#
...
#$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; sudo $rfxBLDCMD  ; echo \"HP1123IPF  :  bldcmd rc = $?\"\""; 
$SSHrfxbldcmd="$SSH \"$pro ; cd $buildTreePath ; pwd ; $rfxBLDCMD  ; echo \"HP1123IPF  :  bldcmd rc = $?\"\""; 

#$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; sudo $tuipBLDCMD  ; echo \"HP1123IPF  :  bldcmd rc = $?\"\""; 
$SSHtuipbldcmd="$SSH \"$pro ; cd $buildTreePathTuip ; pwd ; $tuipBLDCMD  ; echo \"HP1123IPF  :  bldcmd rc = $?\"\""; 
