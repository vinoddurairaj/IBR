...
#    10 22 * * cd dev/branch/RFXTUIP26cron ; /usr/bin/perl bRrunMaincron263.pl
###################################################
#####################################################

open (STDOUT,">runMainCron263.txt");
open (STDERR,">>&STDOUT");

chdir "/home0/bmachine/dev/branch/RFXTUIP263/tdmf_ose/unix_v1.2/btools";
