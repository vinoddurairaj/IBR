...
f none /etc/init.d/%PKGNM%-stopdriver 0555 bin bin
f none /etc/init.d/%PKGNM%-rcedit 0555 bin bin
f none %PKGNM%/bin/%Q%chfs 0555 bin bin
f none %PKGNM%/libexec/chfs_install 0555 bin bin
f none %PKGNM%/libexec/chfs_remove 0555 bin bin
d none /%ROOTDIR%/etc/%Q%/hacmp 0755 bin bin
f none /%ROOTDIR%/etc/%Q%/hacmp/cl_activate_dtc 0555 bin bin
f none /%ROOTDIR%/etc/%Q%/hacmp/cl_deactivate_dtc 0555 bin bin
f none /%USRDIR%/usr/%Q%/bin/dtcmodhacmp 0555 bin bin
...
#f none %PKGNM%/doc/pdf/AdminGuide.pdf 0755 bin bin
#f none %PKGNM%/doc/pdf/InstallGuide.pdf 0755 bin bin
#f none %PKGNM%/doc/pdf/MessageGuide.pdf 0755 bin bin
EOAIXTRAS
fi
