...
if [ ${OSTYP} = "Linux" ]
then
	echo "Do nothing rebrand with for ${OSTYP}";
	exit 0;
fi
	...
	do
		...
		case ${opt} in
			b)
				case ${brand} in
					TDMFBRAND) 
						#echo "$0: No need to rebrand ${brand}";ex
						#
						QNAME=dtc;
						CAPQNAME=DTC;
						OEMNAME=SFTK;;
...
/opt/LGTOdtc/lib/blt2.4 /opt/${OEMNAME}${QNAME}/lib/blt2.4\n
/opt/LGTOdtc/lib/tix4.1 /opt/${OEMNAME}${QNAME}/lib/tix4.1\n
/opt/LGTOdtc/lib /opt/${OEMNAME}${QNAME}/lib\n
/opt/LGTOdtc/lib/tcl8.0 /opt/${OEMNAME}${QNAME}/lib/tcl8.0"
;;
...
#/opt/LGTOdtc/include/tcl.h /opt/${OEMNAME}${QNAME}/include/tcl.h\n
#/opt/LGTOdtc/include/tk.h /opt/${OEMNAME}${QNAME}/include/tk.h"
