 ...
 */
#ifndef _FTD_DYNAMIC_ACTIVATION_AIX_H_
#define _FTD_DYNAMIC_ACTIVATION_AIX_H_
...
typedef int (*read_func_ptr) (dev_t dev, struct uio * uio, chan_t  chan, void * extptr);
typedef int (*write_func_ptr) (dev_t dev, struct uio * uio, chan_t  chan, int  ext);
...
#endif // _FTD_DYNAMIC_ACTIVATION_AIX_H_
