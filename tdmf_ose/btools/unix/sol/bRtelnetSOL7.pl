...
############################
#
#  perl -w -I..\.. bRtelnetSOL7.pl
#
#	telnet to SOL7 build machine 
#	make  :  build it
#	make  :  package
#	ready for ftp 
#
...
$branchdir="$branchdir";
$workarea="/BUILDS/usr/bmachine/dev/$branchdir/tdmf_ose/btools/unix";
$workarea0="/BUILDS/usr/bmachine/dev/$branchdir/tdmf_ose/builds/$Bbnum/tdmf_ose/btools/unix/sol";
$workarea1="/BUILDS/usr/bmachine/dev/$branchdir/tdmf_ose/builds/";
$userid="bmachine";
...
use Net::Telnet ();
      ...
      print "\nbRtelnetSOL7.pl  :  getcode array :\n@getcode";


#####################################
###################################
#  telnet call to bRcreateSOL7.pl
###################################
#####################################
