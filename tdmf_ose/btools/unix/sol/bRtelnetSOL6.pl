...
############################
#
#  perl -w -I..\.. bRtelnetSOL6.pl
#
#	telnet to SOL6 build machine 
#	make  :  build it
#	make  :  package
#	ready for ftp 
#
...
############################
#
# STDERR / STDOUT to SOL6.txt
#
############################
##############################

open (STDOUT, ">SOL6.txt");
open (STDERR, ">>&STDOUT");
...
use Net::Telnet ();
      ...
      print "\nbRtelnetSOL6.pl  :  getcode array :\n@getcode";

#####################################
###################################
#  telnet call to bRcreateSOL6.pl
###################################
#####################################
...
use Net::Telnet ();
      ...
      $t->open("129.212.102.212");
      $t->login($userid, $passwd);
      #@rmrf = $t->cmd( "cd $workarea1 ; pwd ; ls -la  ");
      @rmrf = $t->cmd( "cd $workarea1 ; rm -rf $Bminus  ");
      print "\nbRtelnetSOL6.pl  :  rmrf array :\n@rmrf";
