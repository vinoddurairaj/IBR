...
############################
#
#  perl -w -I..\.. bRtelnetHP11i.pl
#
#	telnet to HP11.11 (11i) build machine 
#	make  :  build it
#	make  :  package
#	ready for ftp 
#
...
############################
#
# STDERR / STDOUT to HP11i.txt
#
############################
##############################

open (STDOUT, ">HP11i.txt");
open (STDERR, ">>&STDOUT");
...
use Net::Telnet ();
      ...
      #$t = new Net::Telnet (Timeout => undef, 
      Prompt => '/bmach11/');  # works with tcsh
      $t->open("129.212.206.134");
      ...
      print "\nbRtelnetHP11i.pl  :  getcode array :\n@getcode";
...
use Net::Telnet ();
      ...
      print "\nbRtelnetHP11i.pl  :  create array :\n@create";

#####################################
###################################
#  adding @tail  :  not getting entire log (especially the return codes)
###################################
#####################################
...
use Net::Telnet ();
      ...
      $t->open("129.212.206.134");
      $t->login($userid, $passwd);
      #@tail = $t->cmd( "cd $workarea0 ; cd .. ;  ls -l makeHP.txt ; tail -25 makeHP.txt");
      @tail = $t->cmd( "cd $workarea0 ; cd .. ;  ls -l makeHP.txt ; tail -25 makeHP.txt");
      print "\nbRtelnetHP11i.pl  :  tail array :\n@tail\n";
...
use Net::Telnet ();
      ...
      @rmrf = $t->cmd( "cd $workarea1 ; pwd ; rm -rf $Bminus  ");
      print "\nbRtelnetHP11.pl  :  rmrf array :\n@rmrf";

print "\n\nEND :  bRtelnetHP11i.pl\n\n";
