/* #ident "@(#)$Id: ftdio.h,v 1.10 2003/11/13 02:48:23 FJjapan Exp $" */
/* 
...
/* MAX number of logcal groups */
#define MAXLG		1000		/* was moved into ftdio.h minimize changes in all sources */
...
#else  /* defined(SOLARIS) */
#if defined(linux)
	ftd_uint64ptr_t timoid;	/* syncmode timer :DK */
#else
...
#if defined(linux)
#if 0
	ftd_int32_t padding; /* sizeof wlheader_t must be multiple of 8 */
#endif
#endif
  }
wlheader_t;
...
#define FTD_MODE_FULLREFRESH	(FTD_M_BITUPDATE | 0x40)
#define FTD_MODE_BACKFRESH	0x20
#define FTD_MODE_SYNCTIMEO (FTD_MODE_TRACKING | 0x80) /* Dynamic Mode Change */
...
#endif
#define FTD_INIT_STOP            _IOW(FTD_CMD, 0x2a, ftd_dev_t_t)
