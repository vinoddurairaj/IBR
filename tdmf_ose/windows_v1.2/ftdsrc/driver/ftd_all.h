 ...
 *
 * $Id: ftd_all.h,v 1.2 2003/06/03 13:59:34 szg00 Exp $
 *
 */
#ifndef  _FTD_ALL_H_ 
#define  _FTD_ALL_H_ 
...
#if defined(_WINDOWS)
FTD_STATUS ftd_flush_lrdb(ftd_dev_t *softp, PIRP Irp);
#else
FTD_STATUS ftd_flush_lrdb(ftd_dev_t *softp, void *notused);
#endif
