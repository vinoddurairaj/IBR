...
// SVG 30-05-03 
// 
// FTD_SET_TRACE_LEVEL does not exist in 1.2... so 
// we don't have a value for it.. hence 
// FTD_INIT_STOP is at 0x29 in this case!
//
#if 0
#define FTD_SET_TRACE_LEVEL      _IOW(FTD_CMD,  0x29, int)
#endif
#define FTD_INIT_STOP            _IOW(FTD_CMD,  0x29, dev_t)
...
// #define NTFOUR
#ifdef NTFOUR
#define FTD_DEV_DIR "\\\\.\\" QNM
#else // #ifdef NTFOUR
#define FTD_DEV_DIR "\\\\.\\Global\\" QNM
#endif // #ifdef NTFOUR
// #undef NTFOUR
