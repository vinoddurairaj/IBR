 ...
 *
 * $Id: cfg.c,v 1.1.1.1 2001/09/14 13:47:48 dturrin Exp $
 *
 */
...
make_ctl_spec_files(int devno)
{
	...
	(void) unlink(buf);
	if (mknod(buf, S_IRUSR | S_IWUSR | S_IFBLK, devno) < 0)
		return E_MKSPECIAL;
...
main(int argc, char *argv[], char *envp[])
{
	...
	/*-
	 * to force driver reloads define me,
	 * though this being here is an artifact
	 * of development and test, and was useful
	 * only when the driver was wrapped around
	 * the axle. this is unnecessary, in fact 
	 * likely dangerous under normal circumstances.
	 */
