# Microsoft Developer Studio Generated NMAKE File, Based on start.dsp
!IF "$(CFG)" == ""
CFG=start - Win32 Debug
!MESSAGE No configuration specified. Defaulting to start - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "start - Win32 Release" && "$(CFG)" != "start - Win32 Debug"
...
!MESSAGE 
!MESSAGE "start - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "start - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\start.exe"

!ELSE 

ALL : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\start.exe"
...
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\ftd_start.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\version.obj"
	-@erase "$(OUTDIR)\start.exe"
	-@erase "$(OUTDIR)\start.pdb"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /Z7 /O2 /I "..\..\lib\liblic" /I "..\..\lib\libftd" /I "..\..\driver" /I "..\..\lib\libutil" /I "..\..\lib\liberr" /I "..\..\lib\liblst" /I "..\..\lib\libproc" /I "..\..\lib\libcomp" /I "..\..\lib\libsock" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_WINDOWS" /Fp"$(INTDIR)\start.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\start.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

TargetPath=.\Release\start.exe
TargetName=Start
SOURCE="$(InputPath)"
...
$(DS_POSTBUILD_DEP) : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\start.exe"
   md C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"
	copy .\Release\start.exe C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"\lrstart.exe
...
ALL : "libutil - Win32 Debug" "libsock - Win32 Debug" "libproc - Win32 Debug" "libmd5 - Win32 Debug" "liblst - Win32 Debug" "libftd - Win32 Debug" "liberr - Win32 Debug" "libcomp - Win32 Debug" "$(OUTDIR)\start.exe"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /Zi /Od /I "..\..\lib\libftd" /I "..\..\driver" /I "..\..\lib\libutil" /I "..\..\lib\liberr" /I "..\..\lib\liblst" /I "..\..\lib\libproc" /I "..\..\lib\libcomp" /I "..\..\lib\libsock" /I "..\..\lib\liblic" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\start.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!INCLUDE "start.dep"
!ELSE 
!MESSAGE Warning: cannot find "start.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\ftd_start.obj" : $(SOURCE) "$(INTDIR)"
