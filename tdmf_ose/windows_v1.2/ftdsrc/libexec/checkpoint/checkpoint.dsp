# Microsoft Developer Studio Project File - Name="checkpoint" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "checkpoint.mak".
!MESSAGE 
...
# PROP Scc_ProjName ""$/ftdsrc/libexec/checkpoint", OYEAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
RSC=rc.exe
...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\lib\libcomp" /I "..\..\lib\libproc" /I "..\..\lib\libsock" /I "..\..\driver" /I "..\..\lib\libftd" /I "..\..\lib\libutil" /I "..\..\lib\liblst" /I "..\..\lib\liberr" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "_WINDOWS" /YX /FD /GZ /c
...
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
TargetPath=.\Debug\checkpoint.exe
TargetName=checkpoint
SOURCE="$(InputPath)"
...
# Name "checkpoint - Win32 Release"
# Name "checkpoint - Win32 Debug"
