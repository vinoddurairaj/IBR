...
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
TargetPath=.\Debug\trace.exe
TargetName=trace
SOURCE="$(InputPath)"
PostBuild_Cmds=md $(TOP)\DEBUG	md $(TOP)\DEBUG\"$(PRODUCTNAME)"	copy $(TargetPath) $(TOP)\DEBUG\"$(PRODUCTNAME)"\$(QNM)$(TargetName).exe
# End Special Build Tool
