# Microsoft Developer Studio Generated NMAKE File, Based on stop.dsp
!IF "$(CFG)" == ""
CFG=stop - Win32 Debug
!MESSAGE No configuration specified. Defaulting to stop - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "stop - Win32 Release" && "$(CFG)" != "stop - Win32 Debug"
...
ALL : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\stop.exe"
...
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\ftd_stop.obj"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\version.obj"
	-@erase "$(OUTDIR)\stop.exe"
	-@erase "$(OUTDIR)\stop.pdb"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /Z7 /O2 /I "..\..\lib\liblic" /I "..\..\lib\libftd" /I "..\..\driver" /I "..\..\lib\libutil" /I "..\..\lib\liberr" /I "..\..\lib\liblst" /I "..\..\lib\libproc" /I "..\..\lib\libcomp" /I "..\..\lib\libsock" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "_WINDOWS" /Fp"$(INTDIR)\stop.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\stop.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
$(DS_POSTBUILD_DEP) : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\stop.exe"
   md C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"
	copy .\Release\stop.exe C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"\lrstop.exe
...
ALL : "libutil - Win32 Debug" "libsock - Win32 Debug" "libproc - Win32 Debug" "libmd5 - Win32 Debug" "liblst - Win32 Debug" "libftd - Win32 Debug" "liberr - Win32 Debug" "libcomp - Win32 Debug" "$(OUTDIR)\stop.exe"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\lib\libftd" /I "..\..\lib\libproc" /I "..\..\lib\liberr" /I "..\..\lib\libutil" /I "..\..\driver" /I "..\..\lib\liblst" /I "..\..\lib\libcomp" /I "..\..\lib\libsock" /I "..\..\lib\liblic" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\stop.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!INCLUDE "stop.dep"
!ELSE 
!MESSAGE Warning: cannot find "stop.dep"
!ENDIF 
!ENDIF 
...
"$(INTDIR)\ftd_stop.obj" : $(SOURCE) "$(INTDIR)"
