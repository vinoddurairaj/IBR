...
#
# Copyright (c) 1997 Legato Systems, Inc.
# All Rights Reserved.
#
#-----------------------------------------------------------------------------
...
proc ftdmkdevlist {sysname {portnum 575} {timeout 60000}} {
	...
	set d(status) -1
	set d(errmsg) "Could not retrieve the device information from $sysname on port $portnum.  Either the master %PRODUCTNAME% daemon process (in.%Q%) is not running on $sysname, or the port number has been specified incorrectly."
	return $gn
    }
