...
usage: $0 -b <build> \[-t <cvstag> \]\n\
  ...
  where <build> is one of:\n\
    hp    - build all HP-UX brands\n\
    hpmti - build HP-UX mti brand\n\
    aix   - build all AIX brands\n\
    aixmti- build AIX mti brand\n\
    sol   - build all SunOS brands\n\
    solmti- build AIX mti brand\n\
    soldtc- build AIX dtc brand\n\
