...
extern int ftd_minphys(struct buf *bp, void *arg);
...
#define	FTD_CONTEXT		u_int

#define FTD_STATUS      int
...
#define FtdpAlloc(size)		malloc(size)
#define FtdpFree(ptr)		free(ptr)
#define FtdpRealloc(ptr, size)	realloc(ptr, size)

/*
 * The default platform eol translation on Unix is FTD_TRANSLATE_LF:
 */

#define	FTD_PLATFORM_TRANSLATION	FTD_TRANSLATE_LF
...
/*
 * The following function is declared in ftdInt.h but doesn't do anything
 * on Unix systems.
 */

#define FtdSetSystemEnv(a,b)

/*
 * The following implements the Unix method for exiting the process.
 */
#define FtdPlatformExit(status) exit(status)

/*
 * The following functions always succeeds under Unix.
 */

#define FtdHasSockets(interp) (FTD_OK)
#define FtdHasPipes() (1)
...
#define FtdpGetDate(t,u) ((u) ? gmtime((t)) : localtime((t)))
#define FtdStrftime(s,m,f,t) (strftime((s),(m),(f),(t)))

#endif /* KERNEL */

#endif /* _FTD_PORT_UNIX */
