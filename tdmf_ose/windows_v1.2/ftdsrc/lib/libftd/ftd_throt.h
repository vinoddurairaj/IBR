/*
 * ftd_throt.h - FTD throttle interface
 * 
...
extern int action_update_tunable (ftd_lg_t *lgp, int verb, int what, int value);

/* -- function prototype(s) for evaluating throttles */
extern void eval_throttles(ftd_lg_t *lgp);
...
extern void update_throttle_measure_values(ftd_lg_t *lgp);

/* -- substitution utilities -- */
extern int substitute_actionstring (ftd_lg_t *lgp, char* instr, char* outstr, 
                                      int* outsize);
/* -- utility */
...
extern void printaction (ftd_lg_t *lgp, char* outstr, action_t* action);
extern void printthrottletrace (ftd_lg_t *lgp, throttle_t* throttle, action_t* action);
