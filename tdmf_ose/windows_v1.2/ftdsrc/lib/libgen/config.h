...
typedef struct tunable_s {
    ...
    int chunkdelay;      
    int iodelay;       
    int bablow;          /* BAB low water mark - used for refresh */      
    int babhigh;         /* BAB high water mark - used for refresh */      
} tunable_t;
...
typedef struct machine {
    ...
    long        iodelayms;       /* delay return from each app write by this */
    int         setiodelayflag;  /* set driver I/O delay by iodelayms */
