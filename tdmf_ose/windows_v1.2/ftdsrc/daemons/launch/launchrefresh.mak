# Microsoft Developer Studio Generated NMAKE File, Based on launchrefresh.dsp
!IF "$(CFG)" == ""
CFG=launchrefresh - Win32 Debug
!MESSAGE No configuration specified. Defaulting to launchrefresh - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "launchrefresh - Win32 Release" && "$(CFG)" != "launchrefresh - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "launchrefresh.mak" CFG="launchrefresh - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "launchrefresh - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "launchrefresh - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
!IF  "$(CFG)" == "launchrefresh - Win32 Release"

OUTDIR=.\launchrefresh_Release
INTDIR=.\launchrefresh_Release
# Begin Custom Macros
OutDir=.\launchrefresh_Release
# End Custom Macros
...
ALL : "$(OUTDIR)\launchrefresh.exe"

!ELSE 

ALL : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\launchrefresh.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\launchrefresh.exe"
	-@erase "$(OUTDIR)\launchrefresh.pdb"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /Z7 /O2 /I "..\..\lib\libftd" /I "..\..\lib\libutil" /I "..\..\lib\liblst" /I "..\..\lib\libsock" /I "..\..\lib\libcomp" /I "..\..\lib\libproc" /I "..\..\lib\liberr" /I "..\..\driver" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "FTD_LAUNCH_REFRESH" /Fp"$(INTDIR)\launchrefresh.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\launchrefresh.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

TargetPath=.\launchrefresh_Release\launchrefresh.exe
TargetName=LaunchRefresh
SOURCE="$(InputPath)"
...
$(DS_POSTBUILD_DEP) : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\launchrefresh.exe"
   md C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"
	copy .\launchrefresh_Release\launchrefresh.exe C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"\lrlaunchrefresh.exe
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"

!ELSEIF  "$(CFG)" == "launchrefresh - Win32 Debug"

OUTDIR=.\launchrefresh_Debug
INTDIR=.\launchrefresh_Debug
# Begin Custom Macros
OutDir=.\launchrefresh_Debug
# End Custom Macros
...
ALL : "libutil - Win32 Debug" "libsock - Win32 Debug" "libproc - Win32 Debug" "libmd5 - Win32 Debug" "liblst - Win32 Debug" "libftd - Win32 Debug" "liberr - Win32 Debug" "libcomp - Win32 Debug" "$(OUTDIR)\launchrefresh.exe"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\lib\libftd" /I "..\..\lib\libutil" /I "..\..\lib\liblst" /I "..\..\lib\libsock" /I "..\..\lib\libcomp" /I "..\..\lib\libproc" /I "..\..\lib\liberr" /I "..\..\driver" /D "_DEBUG" /D "FTD_LAUNCH_REFRESH" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\launchrefresh.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!IF EXISTS("launchrefresh.dep")
!INCLUDE "launchrefresh.dep"
!ELSE 
!MESSAGE Warning: cannot find "launchrefresh.dep"
!ENDIF 
!ENDIF 
