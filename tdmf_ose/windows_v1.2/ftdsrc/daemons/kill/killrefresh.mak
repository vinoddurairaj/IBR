# Microsoft Developer Studio Generated NMAKE File, Based on killrefresh.dsp
!IF "$(CFG)" == ""
CFG=killrefresh - Win32 Debug
!MESSAGE No configuration specified. Defaulting to killrefresh - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "killrefresh - Win32 Release" && "$(CFG)" != "killrefresh - Win32 Debug"
...
OUTDIR=.\killrefresh_Release
INTDIR=.\killrefresh_Release
# Begin Custom Macros
OutDir=.\killrefresh_Release
# End Custom Macros
...
ALL : "$(OUTDIR)\killrefresh.exe"

!ELSE 

ALL : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\killrefresh.exe"
...
!ENDIF 
	...
	-@erase "$(OUTDIR)\killrefresh.exe"
	-@erase "$(OUTDIR)\killrefresh.pdb"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /Z7 /O2 /I "..\..\lib\libftd" /I "..\..\lib\libutil" /I "..\..\lib\liblst" /I "..\..\lib\libsock" /I "..\..\lib\libcomp" /I "..\..\lib\libproc" /I "..\..\lib\liberr" /I "..\..\driver" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "FTD_KILL_REFRESH" /Fp"$(INTDIR)\killrefresh.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
"$(OUTDIR)\killrefresh.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
$(DS_POSTBUILD_DEP) : "libutil - Win32 Release" "libsock - Win32 Release" "libproc - Win32 Release" "libmd5 - Win32 Release" "liblst - Win32 Release" "libftd - Win32 Release" "liberr - Win32 Release" "libcomp - Win32 Release" "$(OUTDIR)\killrefresh.exe"
   md C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"
	copy .\killrefresh_Release\killrefresh.exe C:\TDMF\Rep_5_01_NT\ftdsrc\"Replication"\lrkillrefresh.exe
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"

!ELSEIF  "$(CFG)" == "killrefresh - Win32 Debug"

OUTDIR=.\killrefresh_Debug
INTDIR=.\killrefresh_Debug
# Begin Custom Macros
OutDir=.\killrefresh_Debug
# End Custom Macros
...
ALL : "libutil - Win32 Debug" "libsock - Win32 Debug" "libproc - Win32 Debug" "libmd5 - Win32 Debug" "liblst - Win32 Debug" "libftd - Win32 Debug" "liberr - Win32 Debug" "libcomp - Win32 Debug" "$(OUTDIR)\killrefresh.exe"
...
F90=df.exe
CPP=cl.exe
CPP_PROJ=/nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\lib\libftd" /I "..\..\lib\libutil" /I "..\..\lib\liblst" /I "..\..\lib\libsock" /I "..\..\lib\libcomp" /I "..\..\lib\libproc" /I "..\..\lib\liberr" /I "..\..\driver" /D "_DEBUG" /D "FTD_KILL_REFRESH" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\killrefresh.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
!IF EXISTS("killrefresh.dep")
!INCLUDE "killrefresh.dep"
!ELSE 
!MESSAGE Warning: cannot find "killrefresh.dep"
!ENDIF 
!ENDIF 
