========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : DiskUser
========================================================================


AppWizard has created this DiskUser application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your DiskUser application.
...
DiskUser.h
    ...
    CDiskUserApp application class.
...
res\DiskUser.ico
    ...
    icon is included by the main resource file DiskUser.rc.
...
DiskUserDlg.h, DiskUserDlg.cpp - the dialog
    These files contain your CDiskUserDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in DiskUser.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CDiskUserDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named DiskUser.pch and a precompiled types file named StdAfx.obj.
