...
usage: $0 -d <distribution root directory> -b <build> -n <seqnum> \n\
  ...
  where <build> is one of:\n\
    hp1020 - make distribution of all brands, HP-UX 1020 only\n\
    hp1100 - make distribution of all brands, HP-UX 1100 only\n\
...
case ${what} in
	hp1020)
		target="hp    - make distribution of all brands, HP-UX 1020 only";
		dist=${hp1020dist};;
	hp1100)
		target="hp    - make distribution of all brands, HP-UX 1100 only";
		dist=${hp1100dist};;
	aix)
