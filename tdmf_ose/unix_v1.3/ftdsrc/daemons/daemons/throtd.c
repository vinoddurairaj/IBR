 ...
 *
 * $Id: throtd.c,v 1.5 2001/10/01 15:43:03 bouchard Exp $
 ***************************************************************************/
...
#elif defined(_AIX)
{
    ...
    while (sd) {
        ...
        statbuf.addr = (ftd_uint64ptr_t)devbuffer;
        ...
        statbuf.addr = (ftd_uint64ptr_t)&devdrvstats;
        ...
        if((err = FTD_IOCTL_CALL(masterfd, FTD_SET_DEV_STATE_BUFFER,  &statbuf)) < 0) {
#ifdef DEBUG_THROTTLE
