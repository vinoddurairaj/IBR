...
#-----------------------------------------------------------------------------
#
# dtcperftool -- Softek TDMF Performance Monitor
#
...
proc ftdpt_build_form {} {
    ...
    wm deiconify .qf
    wm withdraw .qf
    wm title .qf "Softek %PRODUCTNAME% Performance Monitor"
...
proc Introduction {} {
    ...
    message $w.vermsg -text "Performance Tool - Version %VERSION%" -aspect 10000 -justify center -font -Adobe-Helvetica-Bold-R-Normal--*-100-*-*-*-*-*-* -bg white    
