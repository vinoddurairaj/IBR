...
//------------------------------------------------------------------------- // ; Internal
//                                                                          // ; Internal
// Registry values for Internet Explorer                                    // ; Internal
//------------------------------------------------------------------------- // ; Internal
...
enum {
    ...
    DBID_SHOWONLY,          // BUGBUG tmp! replace w/ cbs::Select
};
...
{
    DWORD   dwSize;             //Size of this structure
    DWORD   dwID;               //For Internal Use: Set it always to zero.
...
DECLARE_INTERFACE_( IActiveDesktop, IUnknown )
{
    ...
    STDMETHOD (GetWallpaper)(THIS_ LPWSTR pwszWallpaper, UINT cchWallpaper) PURE;
    STDMETHOD (SetWallpaper)(THIS_ LPCWSTR pwszWallpaper) PURE;
    STDMETHOD (GetWallpaperOptions)(THIS_ LPWALLPAPEROPT pwpo) PURE;
    STDMETHOD (SetWallpaperOptions)(THIS_ LPCWALLPAPEROPT pwpo) PURE;
    STDMETHOD (GetPattern)(THIS_ LPWSTR pwszPattern, UINT cchPattern) PURE;
    STDMETHOD (SetPattern)(THIS_ LPCWSTR pwszPattern) PURE;
    STDMETHOD (GetComponentsOptions)(THIS_ LPCOMPONENTSOPT pco) PURE;
    STDMETHOD (SetComponentsOptions)(THIS_ LPCCOMPONENTSOPT pco) PURE;
    STDMETHOD (AddComponent)(THIS_ LPCCOMPONENT pcomp) PURE;
    STDMETHOD (ModifyComponent)(THIS_ LPCCOMPONENT pcomp, DWORD dwFlags) PURE;
    STDMETHOD (RemoveComponent)(THIS_ LPCCOMPONENT pcomp) PURE;
    STDMETHOD (GetComponentsCount)(THIS_ LPINT lpiCount) PURE;
    STDMETHOD (GetComponent)(THIS_ int nComponent, LPCOMPONENT pcomp) PURE;
    STDMETHOD (GetComponentByID)(THIS_ DWORD dwID, LPCOMPONENT pcomp) PURE;
    STDMETHOD (GenerateComponentHtml)(LPCWSTR pwszFileName, LPCOMPONENT pcomp) PURE;
};
...
DECLARE_INTERFACE_(IShellChangeNotify, IUnknown)
{
    ...
    STDMETHOD(OnChange) (LONG lEvent, LPCITEMIDLIST pidl1, LPCITEMIDLIST pidl2) PURE;
} ;
...
//
#undef  INTERFACE
#define INTERFACE  IQueryInfoTip
DECLARE_INTERFACE_(IQueryInfoTip, IUnknown)
{
    // *** IUnknown methods ***
    STDMETHOD(QueryInterface) (THIS_ REFIID riid, LPVOID * ppvObj) PURE;
    STDMETHOD_(ULONG,AddRef) (THIS)  PURE;
    ...
    // *** IQueryInfoTip methods ***
    STDMETHOD(GetInfoTip)(DWORD dwFlags, WCHAR **ppwszTip) PURE;
} ;
...
//;bbegin_internal// temp remove from internal after figure out how to solve split problem
//
...
SHSTDAPI CDefFolderMenu_Create2(LPCITEMIDLIST pidlFolder, HWND hwndOwner,
...
SHSTDAPI_(BOOL) SHOpenPropSheetA(LPCSTR pszCaption, HKEY ahkeys[], UINT cikeys, 
				 const CLSID * pclsidDefault, LPDATAOBJECT pdtobj,
