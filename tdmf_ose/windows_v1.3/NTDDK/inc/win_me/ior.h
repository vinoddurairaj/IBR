...
**  Function:
**
**  Each layer passes this request down with modification to the IDE port
**  driver.  
**
**  Notes:
**
...
**  Function:
**
**  Issues Inquiry command to the device, and fills the supplied buffer with
**  Inquiry data
**
**  Notes:
**
...
**  Function:
**
**  Instructs the floppy driver to determine the number of devices on this
**  controller
**
**  Notes:
**
...
**  Function:
**
**  Device specified should be accessed to start a spinup operation, if 
**  possible.   Request should be called back without waiting for the drive
**  to complete the spinup operation.
**  controller
**
**  If this functionality is supported, IORS_SUCCESS is returned.  Otherwise
