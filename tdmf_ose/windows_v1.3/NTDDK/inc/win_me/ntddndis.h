...
Revision History:
	...
	Kyle brandon (kyleb)	12/03/96		added PnP and PM OIDs.
...
#define IOCTL_NDIS_QUERY_DEVICE_POWER	_NDIS_CONTROL_CODE(3, METHOD_OUT_DIRECT)
#define IOCTL_NDIS_SET_DEVICE_POWER		_NDIS_CONTROL_CODE(4, METHOD_OUT_DIRECT)
...
//
//	GUID definition if it's not already defined.
//
#ifndef GUID_DEFINED
#define GUID_DEFINED
...
//	Optional OIDs
//
#define OID_GEN_MINIPORT_CAPABILITIES			0x00010201
...
//
//	NDIS miniport capabilities bits (OID_GEN_MINIPORT_CAPABILITIES)
//
#define	NDIS_CAP_ADD_V4_TCP_CHECKSUM			0x00000001
#define	NDIS_CAP_ADD_V4_UDP_CHECKSUM			0x00000002
#define	NDIS_CAP_ADD_V4_IP_CHECKSUM				0x00000004

#define	NDIS_CAP_VERIFY_V4_TCP_CHECKSUM			0x00000008
#define	NDIS_CAP_VERIFY_V4_UDP_CHECKSUM			0x00000010
#define	NDIS_CAP_VERIFY_V4_IP_CHECKSUM			0x00000020

#define	NDIS_CAP_ADD_V6_TCP_CHECKSUM			0x00000040
#define	NDIS_CAP_ADD_V6_UDP_CHECKSUM			0x00000080
#define	NDIS_CAP_ADD_V6_IP_CHECKSUM				0x00000100

#define	NDIS_CAP_VERIFY_V6_TCP_CHECKSUM			0x00000200
#define	NDIS_CAP_VERIFY_V6_UDP_CHECKSUM			0x00000400
#define	NDIS_CAP_VERIFY_V6_IP_CHECKSUM			0x00000800
