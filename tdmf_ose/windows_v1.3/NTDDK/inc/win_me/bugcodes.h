...
// MessageText:
//
//  Microsoft (R) Windows NT (R) Version %hs (Build %u%hs)
//
...
// MessageText:
//
//  The ACPI Bios in this system is not fully compliant to the specification. Please
//  read the README.TXT for possible workarounds, or contact your system vendor for
//  an updated Bios.
//
...
//
// MessageId: DRIVER_CORRUPTED_POOL
//
// MessageText:
//
//  
...
//  troubleshooting Stop errors.
//
#define DRIVER_CORRUPTED_POOL            ((ULONG)0x000000C5L)
