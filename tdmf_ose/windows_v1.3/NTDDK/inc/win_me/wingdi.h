...
#define NTM_OPENTYPE        0x00020000
#define NTM_MULTIPLEMASTER  0x00040000
#define NTM_MM_INSTANCE     0x00080000
...
typedef struct tagMMAXIS
{
    DWORD axTag;
    LONG  axValue;
} MMAXIS, *PMMAXIS, FAR *LPMMAXIS;
...
typedef struct tagDESIGNVECTOR
{
    DWORD  dvReserved;
    DWORD  dvNumAxes;
    MMAXIS dvAxis[MM_MAX_NUMAXES];
} DESIGNVECTOR, *PDESIGNVECTOR, FAR *LPDESIGNVECTOR;

WINGDIAPI int  WINAPI AddFontResourceExA(LPCSTR,DWORD, DESIGNVECTOR *);
WINGDIAPI int  WINAPI AddFontResourceExW(LPCWSTR,DWORD, DESIGNVECTOR *);
#ifdef UNICODE
#define AddFontResourceEx  AddFontResourceExW
#else
#define AddFontResourceEx  AddFontResourceExA
#endif // !UNICODE
WINGDIAPI BOOL WINAPI RemoveFontResourceExA(LPCSTR,DWORD, DESIGNVECTOR *);
WINGDIAPI BOOL WINAPI RemoveFontResourceExW(LPCWSTR,DWORD, DESIGNVECTOR *);
#ifdef UNICODE
...
{
    BYTE   SourceBlend;
    BYTE   DestinationBlend;
    BYTE   SourceConstantAlpha;
    BYTE   DestinationConstantAlpha;
}BLENDFUNCTION,*PBLENDFUNCTION;

#define AC_ZERO                 0
#define AC_ONE                  1
#define AC_SRC_ALPHA            2
#define AC_ONE_MINUS_SRC_ALPHA  3
#define AC_DST_ALPHA            4
#define AC_ONE_MINUS_DST_ALPHA  5
#define AC_SRC_COLOR            6
#define AC_DST_COLOR            7
#define AC_ONE_MINUS_SRC_COLOR  8
#define AC_ONE_MINUS_DST_COLOR  9
#define AC_SRC_OVER             10
#define AC_SRC_UNDER            11

WINGDIAPI BOOL  WINAPI AlphaBlend(HDC,int,int,int,int,HDC,int,int,int,int,BLENDFUNCTION);

WINGDIAPI BOOL  WINAPI TransparentBlt(HDC,int,int,int,int,HDC,int,int,int,int,UINT);

#define GRADIENT_FILL_DITHER_1 1
#define GRADIENT_FILL_GAMMA    2
#define GRADIENT_FILL_RECT_H    0x00000100
#define GRADIENT_FILL_TRIANGLE  0x00001000
#define GRADIENT_FILL_RECT_V    0x00010000
...
#endif  // USE_MIRRORING					// (Added in ME merge)
...
typedef BOOL (CALLBACK *WGLENUMTEXTUREFORMATSCALLBACK)(LPDDSURFACEDESC,
                                                       LPVOID);

WINGDIAPI BOOL  WINAPI wglBindDirectDrawTexture(LPDIRECTDRAWSURFACE);
WINGDIAPI BOOL  WINAPI wglEnumTextureFormats(WGLENUMTEXTUREFORMATSCALLBACK,
                                             LPVOID);
