...
typedef BOOL (CALLBACK* LANGUAGEGROUP_ENUMPROCW)(LGRPID, LPWSTR, LPWSTR, DWORD, LPARAM);
typedef BOOL (CALLBACK* LANGGROUPLOCALE_ENUMPROCW)(LGRPID, LCID, LPWSTR, LPARAM);
typedef BOOL (CALLBACK* UILANGUAGE_ENUMPROCW)(LPWSTR, LPARAM);
