...
//		ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Sequential access hint
//		³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Commit data on file write
//		³³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	No critical error handler on error
//		³³³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Files > 2 GBytes OK to open
//		³³³³
//		³³³³ ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Undefined (never use this flag)
//		³³³³ ³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Use alias-hint for short-name-tail
//		³³³³ ³³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	No file compression
//		³³³³ ³³³ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	No file caching
//		³³³³ ³³³³
//		³³³³ ³³³³ ÚÄÄÄÄÄÄÄÄÄÄÄÄ	No file handle inheritance
//		³³³³ ³³³³ ³ÚÂÂÄÄÄÄÄÄÄÄÄ	Sharing modes
//		³³³³ ³³³³ ³³³³
//		³³³³ ³³³³ ³³³³ ÚÄÄÄÄÄÄÄ	Random access hint
//		³³³³ ³³³³ ³³³³ ³ÚÄÄÄÄÄÄ	No last-access-date modification
//		³³³³ ³³³³ ³³³³ ³³ÚÂÄÄÄÄ	Access modes read/write/read-write
// 		1111 11³³ ³³³³ ³³³³
// Bit	5432 1098 7654 3210
//		³ ³³ ³  ³
//		³ ³³ ³  ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Do not cache read/write data
//		³ ³³ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Reopen an "open" file (private IFS flag)
//		³ ³ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	I/O via the swapper
//		³ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	I/O via the 32-bit loader
//		ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	Memory mapped read/write
//								ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
//								Ring-0-flags or private-flags
//
//	The R0_NO_CACHE and OPEN_FLAGS_NO_CACHE happen to correspond, but that
//	is just an accident.
//
//	However, the R0_SWAPPER_CALL, R0_MM_READ_WRITE, R0_LOADER_IO and
//	OPEN_FLAGS_REOPEN flags conflict with their DOS API usage.  Since
//	these three flags are passed to FSDs via ir_options, the conflicting
//	DOS flags must be passed via another field.  The IFS translates the
//	DOS API open-mode-flags and passes them to the FSDs in another field:
//	the third byte of ir_attr field which is unused on VFN_OPEN in win95.  
//
//	DOS open-mode flag in BX	Is translated to ir_attr flag
//	ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ	ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
//	EXTENDED_SIZE_OK			OPEN_FLAGS_EXTENDED_SIZE 
//	OPEN_RAND_ACCESS_HINT		OPEN_FLAGS_RAND_ACCESS_HINT
//	OPEN_SEQ_ACCESS_HINT		OPEN_FLAGS_SEQ_ACCESS_HINT	
//
//	These flags are typically NOT supported on down level FSDs.  In fact,
//	they are filtered out of the IOREQ sent to the FSD by the IFS unless
//	the FSD indicates that it supports these features via the 
//	FS_ATTRIB_LARGE_MEDIA and FS_ATTRIB_ACCESS_METHOD_HINTS flags.
//	These flags are passed by the FSD to the IFS when it registers with
//	the IFS using the Ifsmgr_RegisterFSDWithPriority service.
//
//	The R0_ flags are ONLY passed to an FSD via the IFS' ring_0 open,
//	and they are the ONLY valid flags to pass in DH.  All others are
//	passed via BX on the ring-0 open.  See the IFS spec for details.
//
...
#define DLC_LOCKS_TAKEN			0x10	/* some level of lock is in effect */
#define DLC_LOCKS_RELEASED		0x20	/* no level of lock is in effect   */


/* These values for ir_options are used only on ring 0 apis */
#define R0_NO_CACHE				0x0100	/* must not cache reads/writes      */
//#define R0_LOADER_CALL		0x0?00	/* called by program loader         */
//#define R0_RDAHEAD_HINT		0x0?00	/* read-ahead hint in ir_aux1       */

#define R0_SWAPPER_CALL			0x1000	/* called by the swapper            */
#define R0_LOADER_IO			0x2000	/* called by program loader         */
										/* same as loader call above but    */
										/* using it would cause the dreaded */
										/* GANGPAGE loading code to be      */
										/* enabled so we don't				*/
...
/** Flag used to indicate an invalid ppath buffer pointer. */

/*NOINC*/
#define	INVPATHBUFPTR	((void *)0xFFFFFBBB)
/*INC*/
