...
//
// Win32 API extentions for OnNow
//
// To allow building files, including both nt.h and windows.h definitions
// below should be bracketed the same way as ntpoapi.h does.
//
...
//
// EXECUTION_STATE for SetThreadExecutionState esFlags
//

#ifdef ES_SYSTEM_REQUIRED
#undef ES_SYSTEM_REQUIRED
#define ES_SYSTEM_REQUIRED	((ULONG)0x00000001)
#endif
#ifdef ES_DISPLAY_REQUIRED
...
//
// LATENCY_TIME for RequestWakeupLatency
//
...
#endif
#define LT_CANCEL_LOWEST_LATENCY LT_DONT_CARE
...
SetMessageWaitingIndicator(
    HANDLE h,
    ULONG MessageWaitingCount
    );

WINBASEAPI
BOOL
WINAPI
CancelWakeupLatencyRequest(
    );
...
//
// Endof Win32 API OnNow Extension
//
...
RegisterSysMsgHandler(
    LPSYSMSG_HANDLER lpSysMsgHandler,
    HANDLE hThread,
    UINT uLowerRange,
    UINT uUpperRange,
    DWORD dwFlags);

#define RSMH_ADD		0x0000
#define RSMH_REMOVE		0x0001
#define RSMH_WANTQUERIES	0x0002
...
#define SSMH_NOTIFY		0x0000
#define SSMH_QUERY		0x0001
#define SSMH_SYNC		0x0002
#define SSMH_WAITFORALL		0x0004
#endif /* WINVER >= 0x040a */
...
//
// Currently defined Trust Providers
//

#define WIN_TRUST_CAPI_PROVIDER         (1L)
#define WIN_TRUST_WINDOWS_COMPATIBLE    (2L)
#define WIN_TRUST_SOFTWARE_PUBLISHER    (3L)

////////////////////////////////////////////////////////////////////
//                                                                 /
//             CAPI CSP Trust Provider                             /
//                                                                 /
////////////////////////////////////////////////////////////////////
...
#define CAPI_TRUST_ACTION_VALID_CSP    (1L)

//
// SubjectForms:
//

#define CAPI_TRUST_FORM_CSP_HANDLE     (1L)
...
#define WIN_SPUB_ACTION_NT_ACTIVATE_IMAGE      (2L)

//
// SubjectForms:
//

#define WIN_SPUB_FORM_TRUSTED_PUBLISHER      (1L)
#define WIN_SPUB_FORM_NT_ACTIVATE_IMAGE      (2L)
...
//
// BUGBUG This structure will change as details of the
// verified images cache are finalized.
//
