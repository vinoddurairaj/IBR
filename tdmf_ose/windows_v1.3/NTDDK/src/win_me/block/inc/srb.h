...
#define SRB_FLAGS_UNSPECFIED_DIRECTION      (SRB_FLAGS_DATA_IN | SRB_FLAGS_DATA_OUT)
#define SRB_FLAGS_UNSPECIFIED_DIRECTION      (SRB_FLAGS_DATA_IN | SRB_FLAGS_DATA_OUT)
#define SRB_FLAGS_ADAPTER_CACHE_ENABLE      0x00000200
#define SRB_FLAGS_BIT_IS_ACTIVE             16
#define SRB_FLAGS_IS_ACTIVE                 1 << SRB_FLAGS_BIT_IS_ACTIVE
...
typedef ULONG SCSI_NOTIFICATION_TYPE, *PSCSI_NOTIFICATION_TYPE;
