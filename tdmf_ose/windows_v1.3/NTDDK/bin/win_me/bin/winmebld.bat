...
rem
rem Usage:
rem winmebld [path_to_ddk_root]
rem
rem Example:
rem winmebld C:\NTDDK
rem
rem *****************************************************
...
:done
%1\bin\win_me\bin\vccheck /p %1 /d
...
:usage
echo.
echo usage: winmebld [path_to_ddk_root] [free / checked]
echo.
echo  Example: winmebld C:\ntddk checked         sets checked build environemnt
