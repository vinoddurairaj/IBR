...
$workarea="/u01/bmachine/iso/$RFWver/$Bbnum/OEM/SF";
$userid="bmachine";
$mdi="mkdir image";
$cdi="cd image";
$UZ="unzip ../$RFWver.$Bbnum.ALL.SF.zip";
$cdd="cd ..";
...
$op1="-L -o $RFWver.$Bbnum.StoneFly.iso -U -v -V $CDLABEL $UID image";
$mki="mkisofs $op0 $op1";
...
if ($@) {
    print "\n\nLINUX :  bRtelnetISO_OEM.pl :  errors : rc = $@\n\n";
    undef ($@);
}

print "\n\nEND : bRtelnetISO_OEM.pl\n\n";
