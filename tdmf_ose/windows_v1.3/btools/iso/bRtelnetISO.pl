...
$workarea="/u01/bmachine/iso/$RFWver/$Bbnum";
$userid="bmachine";
$mdi="mkdir image";
$cdi="cd image";
$UZ="unzip ../$RFWver.$Bbnum.ALL.zip";
$cdd="cd ..";
$CDLABEL="$RFWver-$Bbnum";
...
$op1="-L -o $RFWver.$Bbnum.iso -U -v -V $CDLABEL $UID image";
$mki="mkisofs $op0 $op1";
...
use Net::Telnet ();
   ...
   $t->login($userid, $passwd);
      ...
      @create = $t->cmd( "cd $workarea; $mdi; $cdi; $UZ; $cdd; $mki");
      #print "\ntelnet cmd : rc = $?\n";  # no value to script....
      print @create;
...
if ($@) {
    print "\n\nLINUX :  bRtelnetISO.pl :  errors : rc = $@\n\n";
    undef ($@);
}
