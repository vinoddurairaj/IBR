...
@ECHO WARNING: AMD64 Native compiling isn't support. Using cross compilers.
REM goto envtest
...
:done
@rem buffer_overflow_checks only on for x86 Server 2003 env.
...
echo.
echo Usage: "setenv <directory> [fre|chk] [64|AMD64] [hal] [WXP|WNET|W2K]"
echo.
