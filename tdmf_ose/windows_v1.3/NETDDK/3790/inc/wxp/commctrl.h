...
ISOLATION_AWARE_INLINE HDSA WINAPI IsolationAwareDSA_Create(int cbItem,int cItemGrow)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DSA_Create");
        if (s_pfn == NULL)
            return result;
    }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDSA_Destroy(HDSA hdsa)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DSA_Destroy");
        if (s_pfn == NULL)
            return fResult;
    }
    fResult = s_pfn(hdsa);
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDSA_DestroyCallback(HDSA hdsa,PFNDSAENUMCALLBACK pfnCB,void*pData)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DSA_DestroyCallback");
        if (s_pfn == NULL)
            return;
    }
...
ISOLATION_AWARE_INLINE PVOID WINAPI IsolationAwareDSA_GetItemPtr(HDSA hdsa,int i)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DSA_GetItemPtr");
        if (s_pfn == NULL)
            return vResult;
    }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareDSA_InsertItem(HDSA hdsa,int i,void*pitem)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DSA_InsertItem");
        if (s_pfn == NULL)
            return nResult;
    }
...
ISOLATION_AWARE_INLINE HDPA WINAPI IsolationAwareDPA_Create(int cItemGrow)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_Create");
        if (s_pfn == NULL)
            return result;
    }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDPA_Destroy(HDPA hdpa)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_Destroy");
        if (s_pfn == NULL)
            return fResult;
    }
    fResult = s_pfn(hdpa);
...
ISOLATION_AWARE_INLINE PVOID WINAPI IsolationAwareDPA_DeletePtr(HDPA hdpa,int i)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_DeletePtr");
        if (s_pfn == NULL)
            return vResult;
    }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDPA_DeleteAllPtrs(HDPA hdpa)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_DeleteAllPtrs");
        if (s_pfn == NULL)
            return fResult;
    }
    fResult = s_pfn(hdpa);
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDPA_EnumCallback(HDPA hdpa,PFNDPAENUMCALLBACK pfnCB,void*pData)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_EnumCallback");
        if (s_pfn == NULL)
            return;
    }
...
ISOLATION_AWARE_INLINE void WINAPI IsolationAwareDPA_DestroyCallback(HDPA hdpa,PFNDPAENUMCALLBACK pfnCB,void*pData)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_DestroyCallback");
        if (s_pfn == NULL)
            return;
    }
    s_pfn(hdpa,pfnCB,pData);
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDPA_SetPtr(HDPA hdpa,int i,void*p)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_SetPtr");
        if (s_pfn == NULL)
            return fResult;
    }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareDPA_InsertPtr(HDPA hdpa,int i,void*p)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_InsertPtr");
        if (s_pfn == NULL)
            return nResult;
    }
...
ISOLATION_AWARE_INLINE PVOID WINAPI IsolationAwareDPA_GetPtr(HDPA hdpa,INT_PTR i)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_GetPtr");
        if (s_pfn == NULL)
            return vResult;
    }
    vResult = s_pfn(hdpa,i);
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareDPA_Sort(HDPA hdpa,PFNDPACOMPARE pfnCompare,LPARAM lParam)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_Sort");
        if (s_pfn == NULL)
            return fResult;
    }
...
ISOLATION_AWARE_INLINE int WINAPI IsolationAwareDPA_Search(HDPA hdpa,void*pFind,int iStart,PFNDPACOMPARE pfnCompare,LPARAM lParam,UINT options)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("DPA_Search");
        if (s_pfn == NULL)
            return nResult;
    }
...
ISOLATION_AWARE_INLINE BOOL WINAPI IsolationAwareStr_SetPtrW(LPWSTR*ppsz,LPCWSTR psz)
{
    ...
    if (s_pfn == NULL)
    {
        s_pfn = (PFN)CommctrlIsolationAwarePrivatetEgCebCnDDeEff_pbMCgLDC_DLL("Str_SetPtrW");
        if (s_pfn == NULL)
            return fResult;
    }
