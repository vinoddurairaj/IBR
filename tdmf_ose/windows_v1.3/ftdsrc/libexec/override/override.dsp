...
# ADD CPP /nologo /MTd /W3 /Gm /GX /ZI /Od /I "..\..\lib\libmngt" /I "..\..\lib\libftd" /I "..\..\lib\liberr" /I "..\..\driver" /I "..\..\lib\liblst" /I "..\..\lib\libproc" /I "..\..\lib\libsock" /I "..\..\lib\libcomp" /I "..\..\lib\libutil" /I "..\..\lib\liblic" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ /c
...
# ADD LINK32 $(TOP)\$(LIBMNGTDBG) $(TOP)\$(LIBPROCDBG) $(TOP)\$(LIBERRDBG) $(TOP)\$(LIBUTILDBG) $(TOP)\$(LIBSOCKDBG) $(TOP)\$(LIBCOMPDBG) $(TOP)\$(LIBLSTDBG) $(TOP)\$(LIBMD5DBG) kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib ws2_32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
