...
typedef struct _ps_group_info {
    ...
    int          state_stamp;   /* state stamp for the group, INACTIVE - STARTED - ACTIVE */
...
extern int ps_set_group_state_stamp(char *ps_name, char *group_name, int value);
