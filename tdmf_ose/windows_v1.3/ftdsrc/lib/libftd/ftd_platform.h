/*
 * ftd_platform.h - FTD platform specific functions
 * 
...
extern int ftd_make_group(int lgnum, dev_t major_num, dev_t *dev_out);
extern int ftd_make_group_event(int lgnum, dev_t major_num, dev_t *dev_out);
extern int ftd_make_devices(char *raw, char *block, dev_t raw_major_num, 
                 dev_t block_major_num, int minor_num, dev_t *raw_dev_out, 
                 dev_t *block_dev_out);
#endif
