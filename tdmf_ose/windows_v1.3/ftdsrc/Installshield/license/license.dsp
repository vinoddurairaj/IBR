...
# ADD LINK32 $(TOP)\$(LIBERRREL) $(TOP)\$(LIBLSTREL) $(TOP)\$(LIBUTILREL) $(TOP)\$(LIBLICREL) $(TOP)\$(LIBSOCKREL) $(TOP)\$(LIBFTDREL) ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /debugtype:both /machine:I386 /def:".\license.def" /opt:ref,icf
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
TargetPath=.\Release\license.dll
SOURCE="$(InputPath)"
PostBuild_Cmds=mkdir "$(TOP)\InstallShield\$(PRODUCTNAME)\Setup Files\Compressed Files\Language Independent\Intel 32\"	copy $(TargetPath) "$(TOP)\InstallShield\$(PRODUCTNAME)\Setup Files\Compressed Files\Language Independent\Intel 32\"
...
# ADD LINK32 $(TOP)\$(LIBERRDBG) $(TOP)\$(LIBLSTDBG) $(TOP)\$(LIBUTILDBG) $(TOP)\$(LIBLICDBG) $(TOP)\$(LIBSOCKDBG) $(TOP)\$(LIBFTDDBG) ws2_32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /pdbtype:sept
# Begin Special Build Tool
