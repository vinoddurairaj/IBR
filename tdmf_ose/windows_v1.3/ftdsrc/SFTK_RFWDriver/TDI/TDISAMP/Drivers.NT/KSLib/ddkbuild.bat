...
set INTERMDIR=%2
if "%mode%"=="checked"	set INTERMDIR=%INTERMDIR%\objchk_w2K_x86\i386
if "%mode%"=="free"		set INTERMDIR=%INTERMDIR%\objfre_w2K_x86\i386
@echo INTERMDIR=%INTERMDIR%

set OUTPATH=%2
@echo  OUTPATH=%OUTPATH%
if "%mode%"=="checked"	set OUTPATH=%OUTPATH%\Debug\i386
if "%mode%"=="free"		set OUTPATH=%OUTPATH%\Release\i386
@echo OUTPATH=%OUTPATH%
