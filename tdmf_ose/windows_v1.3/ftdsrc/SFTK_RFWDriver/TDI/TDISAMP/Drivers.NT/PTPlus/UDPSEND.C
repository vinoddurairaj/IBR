...
//
//                   UDP Send Function Filters - UDPSend.c
//
...
LIST_ENTRY FreeDGSendReqList;


/////////////////////////////////////////////////////////////////////////////
//// TDIH_TdiSendDatagramComplete
//
// Purpose
//
// Parameters
   ...
   )
{
   ...
   KdPrint(( "TDIH_TdiSendDatagramComplete: Status: 0x%8.8X\n", Status ));
   ...
   {
      KdPrint(( "TDIH_SendDatagramComplete: Invalid Device Object Pointer\n" ));
...
//
// Purpose
// This is the hook for TdiSendDatagram
//
// Parameters
//
// Return Value
   ...
   )
{
   ...
   KdPrint(( "TDIH_TdiSendDatagram: Entry...\n" ));
   ...
   try
   {
      ...
      if (Irp->CurrentLocation == 1)
      {
         ...
         KdPrint(("TDIH_TdiSendDatagram encountered bogus current location\n"));
