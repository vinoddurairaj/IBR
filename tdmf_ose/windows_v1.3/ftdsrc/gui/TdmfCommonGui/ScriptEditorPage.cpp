// ScriptEditorPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CScriptEditorPage property page

IMPLEMENT_DYNCREATE(CScriptEditorPage, CPropertyPage)

CScriptEditorPage::CScriptEditorPage() 
:CPropertyPage(CScriptEditorPage::IDD)
{
	//{{AFX_DATA_INIT(CScriptEditorPage)
	m_ScriptEdit = _T("");
	m_FileSelect = _T("");
	m_strTotChar = _T("0");
	//}}AFX_DATA_INIT
...
void CScriptEditorPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CScriptEditorPage)
...
BEGIN_MESSAGE_MAP(CScriptEditorPage, CPropertyPage)
	//{{AFX_MSG_MAP(CScriptEditorPage)
...
/////////////////////////////////////////////////////////////////////////////
// CScriptEditorPage message handlers
BOOL CScriptEditorPage::OnInitDialog() 
{
	USES_CONVERSION;
...
BOOL CScriptEditorPage::LoadScriptComboBox()
{
...
void CScriptEditorPage::OnSelchangeCboFileSelect() 
{
...
void CScriptEditorPage::OnDestroy() 
{
...
void CScriptEditorPage::OnButtonSend() 
{
    UpdateData(true);
...
void CScriptEditorPage::OnBtnSave() 
{
	UpdateData(true);
...
void CScriptEditorPage::OnButtonNew() 
{
...
void CScriptEditorPage::OnButtonDelete() 
{
    if(m_pCrtScriptServerFile != NULL)
    {
...
bool CScriptEditorPage::SelectTheScriptServerFile(long ScriptServerID)
{
...
void CScriptEditorPage::OnChangeRicheditctrl() 
{
    UpdateData(true);
    m_ScriptEdit.TrimRight();
    m_strTotChar.Format("%d",m_ScriptEdit.GetLength() );
...
bool CScriptEditorPage::IsFilenameAlreadyExistInTheComboBox(CString strFilename)
{
   	// Cleanup
	int nCount = m_CBO_FileSelect_Ctrl.GetCount( ) ;
...
void CScriptEditorPage::VerifyIfTheFileContenthasBeenModify()
{
...
BOOL CScriptEditorPage::AllTheContentISCorrect(CString &str)
{
    CString strResult;
    if(!str.IsEmpty())
    {
...
void CScriptEditorPage::OnBtnImportScripts() 
{
    int nScriptID = -1 ;
    if(m_pCrtScriptServerFile != NULL)
    {
