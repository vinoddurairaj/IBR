...
# ADD LINK32 C:\NTDDK\libfre\i386\int64.lib C:\NTDDK\libfre\i386\ntoskrnl.lib C:\NTDDK\libfre\i386\hal.lib /nologo /base:"0x10000" /version:4.0 /entry:"DriverEntry" /pdb:none /map /debug /debugtype:both /machine:IX86 /nodefaultlib /out:"Free\$(PRODUCTNAME)Block.sys" /libpath:"C:\NTDDK\libchk\i386\\" /driver /IGNORE:4001,4037,4039,4065,4078,4087,4089,4096 /MERGE:_PAGE=PAGE /MERGE:_TEXT=.text /SECTION:INIT,d /MERGE:.rdata=.text /FULLBUILD /RELEASE /FORCE:MULTIPLE /OPT:REF /OPTIDATA /align:0x20 /osversion:4.00 /subsystem:native
# Begin Custom Build - Striping Symbols
InputPath=.\Free\$(PRODUCTNAME)Block.sys
SOURCE="$(InputPath)"

"$(TOP)\driver\Free\$(PRODUCTNAME)Block.dbg" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	rebase -x .. -b 0x10000 $(TOP)\driver\Free\$(PRODUCTNAME)Block.sys

# End Custom Build
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=md $(TOP)\"$(PRODUCTNAME)"	copy Free\$(PRODUCTNAME)Block.sys $(TOP)\"$(PRODUCTNAME)"\$(PRODUCTNAME)Block.sys
...
# ADD CPP /nologo /Gz /W3 /Z7 /Oi /Gy /I "C:\NTDDK\inc" /I "C:\NTDDK\inc\ddk" /FI"warning.h" /D DBG=1 /D WIN32=100 /D "_DEBUG" /D "_WINDOWS" /D "STD_CALL" /D CONDITION_HANDLING=1 /D NT_UP=1 /D NT_INST=0 /D _NT1X_=100 /D WINNT=1 /D _WIN32_WINNT=0x0400 /D WIN32_LEAN_AND_MEAN=1 /D DEVL=1 /D FPO=0 /D "NDEBUG" /D _DLL=1 /D _X86_=1 /D "UNICODE" /D "_CPU_X86_" /D "KERNEL" /D POOL_TAGGING=1 /Fp".\Checked/Ftd.pch" /YX /Fo".\Checked/" /Fd".\Checked/" /FD /Zel -cbstring /QIfdiv- /QIf /GF /c
...
# ADD LINK32 C:\ntddk\libchk\i386\int64.lib c:\ntddk\libchk\i386\ntoskrnl.lib c:\ntddk\libchk\i386\hal.lib /nologo /base:"0x10000" /version:4.0 /stack:0x200000 /entry:"DriverEntry" /map /debug /machine:IX86 /nodefaultlib /out:"Checked\$(PRODUCTNAME)Block.sys" /libpath:"$(BASEDIR)\libchk\i386\\" /driver /debug:notmapped,FULL /IGNORE:4001,4037,4039,4065,4078,4087,4089,4096 /MERGE:_PAGE=PAGE /MERGE:_TEXT=.text /SECTION:INIT,d /MERGE:.rdata=.text /FULLBUILD /RELEASE /FORCE:MULTIPLE /OPT:REF /OPTIDATA /align:0x20 /osversion:4.00 /subsystem:native
# SUBTRACT LINK32 /pdb:none
# Begin Custom Build - Striping Symbols
InputPath=.\Checked\$(PRODUCTNAME)Block.sys
SOURCE="$(InputPath)"

"$(TOP)\driver\Checked\$(PRODUCTNAME)Block.dbg" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	rebase -x .. -b 0x10000 $(TOP)\driver\Checked\$(PRODUCTNAME)Block.sys

# End Custom Build
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=md $(TOP)\"$(PRODUCTNAME)"\debug	copy Checked\$(PRODUCTNAME)Block.sys $(TOP)\"$(PRODUCTNAME)"\debug\$(PRODUCTNAME)Block.sys
# End Special Build Tool
