...
ALL : "$(OUTDIR)\$(PRODUCTNAME)block.sys" "$(TOP)\driver\Free\$(PRODUCTNAME)block.dbg"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\$(PRODUCTNAME)block.map"
	-@erase "$(OUTDIR)\$(PRODUCTNAME)block.sys"
	-@erase "$(TOP)\driver\Free\$(PRODUCTNAME)block.dbg"
...
"$(OUTDIR)\$(PRODUCTNAME)block.sys" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
$(DS_POSTBUILD_DEP) : "$(OUTDIR)\$(PRODUCTNAME)block.sys" "$(TOP)\driver\Free\$(PRODUCTNAME)block.dbg"
...
ALL : "$(OUTDIR)\$(PRODUCTNAME)block.sys" "$(TOP)\driver\Checked\$(PRODUCTNAME)block.dbg"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\$(PRODUCTNAME)block.map"
	-@erase "$(OUTDIR)\$(PRODUCTNAME)block.sys"
	-@erase "$(TOP)\driver\Checked\$(PRODUCTNAME)block.dbg"
